"""Module for creating and manipulating characters."""
...
class Character:
    ...
    # Диапозон значений атаки
    RANGE_VALUE_ATTACK = (1, 3)
    # Диапозон значения защиты
    RANGE_VALUE_DEFENCE = (1, 5)
    # Константы специльных умений
    SPECIAL_BUFF = 15
    SPECIAL_SKILL = 'Удача'
    ...
    def defence(self):
        """Описывает метод защиты"""
        value_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return f'{self.name} блокировал {value_defence} ед. урона.'

    def special(self):
        """Описывает метод специальных умений"""
        return (
...
def start_training(character: Character) -> str:
    ...
    while cmd != 'skip':
        ...
        if cmd in trening_types:
            print(trening_types[cmd]())
